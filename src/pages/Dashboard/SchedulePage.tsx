    ...
    <div className="space-y-6">
      ...
      {mySchedule.length === 0 ? (
        <div className="bg-white rounded-xl shadow-soft p-12 text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">Расписание пусто</h3>
          <p className="mt-2 text-gray-500">Ваше расписание ещё не заполнено.</p>
        </div>
      ) : (
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          <p className="font-medium text-gray-900">
                            Предмет #{lesson.subject_id}
                          </p>
                          {lesson.room && (
                            <p className="text-sm text-gray-500">Каб. {lesson.room}</p>
                          )}
                        </div>
