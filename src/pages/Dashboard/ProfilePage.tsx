...
export default function ProfilePage() {
   ...
   return (
      <div className="max-w-2xl mx-auto space-y-6">
         <h2 className="text-2xl font-bold text-gray-900">Իմ պրոֆիլը</h2>
         ...
         <div className="bg-white rounded-xl shadow-soft overflow-hidden">
            ...
            <div className="p-6 space-y-6">
               ...
               <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Email-ը փոփոխման ենթակա չէ</p>
               </div>
               ...
               <div>
                  ...
                  {isEditing ? (
                     ...
                     <p className="mt-1 text-gray-900">{user?.phone || 'Նշված չէ'}</p>
                  )}
               </div>

               <div>
                  <span className="block text-sm font-medium text-gray-700">Դեր</span>
                  <p className="mt-1 text-gray-900">{getRoleLabel(user?.role)}</p>
               </div>

               <div>
                  <span className="block text-sm font-medium text-gray-700">Կարգավիճակ</span>
                  <div className="mt-1 flex items-center">
                     ...
                     >
                        {user?.is_verified ? 'Հաստատված է' : 'Հաստատված չէ'}
                     </span>
                     <span
