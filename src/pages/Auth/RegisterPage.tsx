...
export default function RegisterPage() {
   ...
   const handleSubmit = async (e: FormEvent) => {
      ...
      if (formData.password !== formData.confirmPassword) {
         setValidationError('Գաղտնաբառերը չեն համընկնում');
         return;
      }

      if (formData.password.length < 6) {
         setValidationError('Գաղտնաբառը պետք է պարունակի առնվազն 6 նիշ');
         return;
      }
   ...
   return (
      <>
         <SEO title="Գրանցում | ImUsum" description="Ստեղծեք ImUsum հաշիվ" />
            ...
            <div className="max-w-md w-full space-y-8">
               <div>
                  ...
                  <p className="mt-2 text-center text-sm text-gray-600">
                     Արդեն ունե՞ք հաշիվ{' '}
                     <Link to="/login" className="font-medium text-blue-main hover:text-blue-dark">
                        Մուտք գործել
                     </Link>
                  </p>
               </div>
