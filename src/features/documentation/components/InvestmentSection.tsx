  ...
  return (
    <section className="py-section mb-section">
      <div className="container">
        {/* Goals Section */}
        <div className="mb-24">
          <Title text="Goals and Investment" />
          <motion.div
        ...
        <div className="mb-24">
          <Title text="Problems and Achievements" />
        ...
        <div>
          <Title
            text="Budget"
            subtitle="The implementation of the ImUsum project requires $200,000"
          />
          ...
          >
            <div className="inline-flex items-center gap-4 px-8 py-4 bg-blue-main rounded-2xl shadow-elevated">
              ...
              <span className="text-display-2 font-bold text-white">
                $200,000
              </span>
            </div>
          </motion.div>
