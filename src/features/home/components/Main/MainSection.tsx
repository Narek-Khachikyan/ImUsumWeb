...
const MainSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative pt-16 pb-32 mb-section-lg overflow-hidden"
    >
      ...
      <div className="relative flex justify-between items-center gap-16">
        ...
        >
          ...
          >
            Welcome to <span className="text-gradient">ImUsum</span>
          </motion.h1>
          ...
          >
            where <span className="text-blue-main">education</span> meets{' '}
            <span className="text-blue-main">inspiration</span>
          </motion.p>
          ...
          >
            Education transcends boundaries, innovation meets inspiration, and
            the future of learning is redefined.
          </motion.p>
