...
const FindUsSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative py-section mb-section overflow-hidden"
    >
        ...
        <div className="flex items-center justify-between gap-16 mt-16">
          ...
          <motion.div className="max-w-xl" style={{ y: contentY }}>
            ...
            >
              ...
              <span className="text-blue-main font-semibold">ImUsum</span>, your
              dedicated educational companion, meticulously crafted to elevate
              your learning experience to new heights.
            </motion.p>
            ...
            >
              <span className="text-blue-main font-medium">ImUsum</span> stands
              as a beacon of knowledge, offering a diverse array of meticulously
              curated courses designed to empower learners across various
              disciplines.
            </motion.p>
